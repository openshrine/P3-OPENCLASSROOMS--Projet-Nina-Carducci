(function ($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    openLightBox(element, lightboxId) {
      ...
      var currentIndex = images.index(element);
    ...
    prevImage(lightboxId) {
      ...
      var imagesCollection = images.filter(function () {
      ...
      lightbox.data("currentIndex", currentIndex);
      lightbox.find(".lightboxImage").attr("src", $(imagesCollection[currentIndex]).attr("src"));
    },
